    ...
    if (widget.scrollController == null) {
      page = Scaffold(
        appBar: AppBar(
          ...
          title:
              _PackageLicensePageTitle(title, subtitle, theme.primaryTextTheme),
        ),
        body: Center(
          child: Material(
      ...
      children: <Widget>[
        Text(title,
            style: Theme.of(context)
                .textTheme
                .headline2
                .copyWith(fontSize: 21.0, color: Color(0xffffffff))),
        Text(subtitle,
            style: Theme.of(context)
                .textTheme
                .caption
...
typedef _DetailPageBuilder = Widget Function(
    BuildContext context, Object arguments, ScrollController scrollController);
